        ...
        public static void Main()
        {
            ...
            if (input == "1")
            {
                ...
                for (int i = 1; i < lines.Length; i++)
                {
                    ...
                    Console.WriteLine($"line: {lineArray}");
                    var name = lineArray[0];
                    var profession = lineArray[1];
                    var level = lineArray[2];
                    var health = lineArray[3];
                    ...
                    var equipmentItems = equipment.Split('|').ToList();
                    equipmentItems.Add("Wooden Shield");
